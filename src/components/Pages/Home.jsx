...
const funfaceData = [
  {
    title:
      "Dr. Rostom is acknowledged for her skill in a wide array of cosmetic and reconstructive surgeries, making her practice a sought-after destination for those seeking quality care in the UAE",
    factNumber: "Unparalleled Expertise",
  },
  {
    title:
      "From breast augmentation to minimally invasive treatments like Botox and dermal fillers, our clinic offers a complete range of services to meet all your aesthetic needs",
    factNumber: "Comprehensive Care",
  },
  {
    title:
      "As a fluent Arabic speaker with a profound understanding of local and regional beauty ideals, Dr. Rostom is particularly esteemed among Arabic-speaking clients, offering a comfortable and culturally sensitive environment.",
...
const educationData = [
  {
    title: "UK Board Certification",
    subTitle:
      "Affirming her professional excellence and dedication to the highest standards of patient care",
  },
  {
    title: "Ain Shams University",
    subTitle:
      "From her early medical education at Ain Shams University in Cairo to her extensive global training",
  },
];
...
const experienceData = [
  {
    ...
    subTitle:
      "Fluent in Arabic and English, Dr. Rostom ensures clear, empathetic consultations for a diverse patient base within the UAE",
  },
  {
    title: "Commitment to Cultural Sensitivity",
    subTitle:
      "Practice is rooted in a deep understanding of the cultural nuances influencing beauty ideals across the Arab world",
  },
];
    ...
    <>
      ...
      >
        <div className="container">
          <FunFact3
            variant="cs-type2"
            title="Why Dr. Mai Rostom Stands Out in Dubai"
            subtitle="Dr. Rostom's approach is tailored to the unique beauty and needs of each patient, ensuring outcomes that celebrate individuality and natural elegance."
            data={funfaceData}
          />
        </div>
      </section>
